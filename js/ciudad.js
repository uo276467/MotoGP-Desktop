class Ciudad {
  ...
  // Construye URL al endpoint con variables horarias/diarias
  ...
  // Pintar en meteorologia.html (día de la carrera)
  pintarCarrera(data) {
    ...
    data.horas.forEach(h => {
      ...
      [h.time, h.temperatura, h.sensacion, h.precipitacion, h.humedad, h.viento_vel, h.viento_dir]
...
c.rellenarDatos(24500, { lat: 43.96139, lon: 12.68333 });
c.escribirCoordenadas();
c.getInfoSecundariaHTML();
c.iniciar();